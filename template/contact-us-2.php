          ...
          <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                  <div class="ps-section__header pt-50">
                    <h2 class="ps-section__title" data-mask="Contact">Entre em contato</h2>



                    <form class="ps-contact__form" action="email.php" method="post">
                      ...
                      <div class="form-group mb-25">
                        <label>Sua mensagem <sub>*</sub></label>
                        <textarea class="form-control" rows="6" name="message"></textarea>
                      </div>
                      <div class="form-group">
                        <button class="ps-btn">Enviar mensagem<i class="ps-icon-next"></i></button>
                      </div>
                    </form>
                  </div>
                </div>

...
<html lang="en">
  <head>
    ...
    <title>Rio Grande - Dashboard</title>
    <!-- Fonts-->
        ...
        <div class="container-fluid">
          ...
          <div class="navigation__column center">
                <ul class="main-menu menu">
                  ...
                  <li class="menu-item"><a href="Instrucoes.php">Instruções</a></li>

                  <li class="menu-item"><a href="cadastro.php">Cadastrar</a></li>

                  <li class="menu-item"><a href="listagem-produtos.php">Listar</a></li>
                    
                  <li class="menu-item"><a href="listagem-categoria.php">Categorias</a></li>
                </ul>
          </div>

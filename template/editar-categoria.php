          ...
          <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                  <div class="ps-section__header pt-50">
                    <h2 class="ps-section__title" data-mask="Edição">Editar categoria</h2>
                    
                    <form class="ps-contact__form" action='backend/edit-categoria.php' method="post">
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="nome_categoria_edit" value="<?php echo $dados['nome_categoria'];?>">
                      </div>
